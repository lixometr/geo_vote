export default [
  ...
  },
  {
  ...
  },
   {
    ...
    position:
      "Научный сотрудник Российского квантового центра. <br> Руководитель команды разработки IT-инфрасткруктуры проекта по созданию системы квантовых коммуникаций, аспирант университета Париж-Сакле, а также участник ряда масштабных проектов по созданию программно-аппаратных сенсорных систем, выпускник МГТУ им. Баумана",
  },
  {
