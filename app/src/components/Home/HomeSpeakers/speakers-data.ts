export default [
  ...
  },
  {
    ...
    position:
      "Вице-президент, Цифровизация и Интеграция,  Шлюмберже Россия и Центральная Азия (докладчик)",
  },
  {
    image: require("@/assets/img/speakers/5.jpeg"),
    name: "Насипов Ленар Альфатович ",
    position:
      "Руководитель направления по сейсморазведке, Цифровизация и Интеграция, Шлюмберже Россия и Центральная Азия (содокладчик) ",
  },
  {
